...
class firstFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        tv= view.findViewById(R.id.tv_1) as TextView
        if (param1=="0"){
        ...
        if(param1=="1")
        {
            view.setBackgroundColor(resources.getColor(R.color.third))
            tv.setText("This is fragment 2")
        }

        if(param1=="2")
        {
            view.setBackgroundColor(resources.getColor(R.color.secondry))
